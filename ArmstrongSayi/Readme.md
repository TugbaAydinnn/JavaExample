...
###### bilinen bu sayı daha sonra basamaklarına bölünerek hesaplanan basamak sayısı üs olarak yazlılır. Son olarak girilen sayı ile hesaplanan değer eşit mi diye kontrol  edilir. Eşit ise "armstrong sayıdır", değilse "armstrong sayı değildir " şeklinde ekrana yazdırıılır.
